# NMOS 6502 Opcodes (local reference)

Source: [6502.org — 6502 Opcodes](https://6502.org/tutorials/6502opcodes.html)  
Direct link (INX): [6502opcodes.html#INX](https://6502.org/tutorials/6502opcodes.html#INX)  
By John Pickens; updated by Bruce Clark and Ed Spittles.

Open preview: `Ctrl+Shift+V` (or right-click → **Open Preview**).

---
6502.org: Tutorials and Aids [[Return to Main Page]](https://6502.org/) NMOS 6502 Opcodes by John Pickens, Updated by Bruce Clark and by Ed Spittles [[Up to Tutorials and Aids]](https://6502.org/tutorials/tutorials.htm)
...
Increments the X register. Wraps `$FF` → `$00`.
